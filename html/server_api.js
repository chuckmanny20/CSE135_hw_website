...
server.post('/performance', (req, res) => {
    ...
    connection.query("INSERT INTO Performance (Pageid, Userid, timeStartLoad, timeEndLoad, timeTotalLoad, wholeTimingObject) VALUES (?, ?, ?, ?, ?, ?);", [req.body.Pageid, req.body.Userid, performanceCollection != null ? performanceCollection['timeStartLoad'] : null, performanceCollection != null ? performanceCollection['timeEndLoad'] : null, performanceCollection != null ? performanceCollection['timeTotalLoad'] : null, performanceCollection != null ? performanceCollection['wholeTimingObject'] : null], (err, rows, fields) => {

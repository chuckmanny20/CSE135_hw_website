...
server.post('/performance', (req, res) => {
    ...
    connection.query("INSERT INTO Performance (Pageid, Userid, timeStartLoad, timeEndLoad, timeTotalLoad, wholeTimingObject) VALUES (?, ?, ?, ?, ?, ?);", [req.body.Pageid, req.body.Userid, performanceCollection != null ? parseFloat(performanceCollection['timeStartLoad']) : null, performanceCollection != null ? parseFloat(performanceCollection['timeEndLoad']) : null, performanceCollection != null ? parseFloat(performanceCollection['timeTotalLoad']) : null, performanceCollection != null ? JSON.stringify(performanceCollection['wholeTimingObject']) : null], (err, rows, fields) => {
...
server.delete('/static/:Pageid', (req, res) => { 
    ...
    if (PageID == 'all') {
        connection.query("DELETE FROM Static;");
...
server.delete('/performance/:Pageid', (req, res) => { 
    ...
    if (PageID == 'all') {
        connection.query("DELETE FROM Performance;");
...
server.delete('/activity/:Pageid', (req, res) => { 
    ...
    if (PageID == 'all') {
        connection.query("DELETE FROM Activity;");
...
server.put('/performance/:Pageid', (req, res) => { 
    ...
    connection.query("INSERT INTO Performance (Pageid, Userid, timeStartLoad, timeEndLoad, timeTotalLoad, wholeTimingObject) VALUES (?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE Userid = ?, timeStartLoad = ?, timeEndLoad = ?, timeTotalLoad = ?, wholeTimingObject = ?;", [req.body.Pageid, req.body.Userid, performanceCollection != null ? parseFloat(performanceCollection['timeStartLoad']) : null, performanceCollection != null ? parseFloat(performanceCollection['timeEndLoad']) : null, performanceCollection != null ? parseFloat(performanceCollection['timeTotalLoad']) : null, performanceCollection != null ? JSON.stringify(performanceCollection['wholeTimingObject']) : null, req.body.Userid, performanceCollection != null ? parseFloat(performanceCollection['timeStartLoad']) : null, performanceCollection != null ? parseFloat(performanceCollection['timeEndLoad']) : null, performanceCollection != null ? parseFloat(performanceCollection['timeTotalLoad']) : null, performanceCollection != null ? JSON.stringify(performanceCollection['wholeTimingObject']) : null], (err, rows, fields) => {
